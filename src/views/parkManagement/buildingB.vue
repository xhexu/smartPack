...
export default {
  ...
  methods: {
    ...
    initData(){
      this.$http.post('/itfenterinfo/list',{floor: 'B', parkCode: 'e'})
        .then((data) => {
          if (data.success) {
...
.layout{
  ...
  .left{
    ...
    .building{
      width:94%;height:70%;opacity:0;margin: 13px 0 0 15px;background:url('/static/bg_view.png') no-repeat center;
